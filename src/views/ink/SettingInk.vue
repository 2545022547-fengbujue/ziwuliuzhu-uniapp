<template>
  <!--
    水墨意境主题设置页
  -->
  <view class="page" :class="[`ui-ink`, `ink-bg-${setting.store.inkBackgroundPeriod}`]">
  <AppNavbar title="设置" />
        ...
        <view class="setting-content">
          ...
          <view class="setting-card solar-card">
            ...
            <view class="setting-row">
              ...
              <view
                class="ink-switch"
                :class="{ active: setting.store.useTrueSolarTime }"
                @tap="setting.onSolarTimeToggle({ detail: { value: !setting.store.useTrueSolarTime } })"
              >
          ...
          <view class="setting-card" :class="{ 'card-collapsed': !setting.najiaExpanded }">
            ...
            <view v-if="setting.najiaExpanded">
              <view class="setting-row">
                ...
                <view
                  class="ink-switch"
                  :class="{ active: setting.store.showFanke }"
                  @tap="setting.onFankeToggle({ detail: { value: !setting.store.showFanke } })"
                >
                  <view class="ink-switch-track"></view>
                  <view class="ink-switch-knob"></view>
                </view>
              ...
              <view class="setting-row no-border">
                ...
                <view
                  class="ink-switch"
                  :class="{ active: setting.store.useHeRiHuYong }"
                  @tap="setting.onHeRiHuYongToggle({ detail: { value: !setting.store.useHeRiHuYong } })"
                >
                  <view class="ink-switch-track"></view>
                  <view class="ink-switch-knob"></view>
                </view>
          ...
          <view class="setting-card" :class="{ 'card-collapsed': !setting.personalExpanded }">
            ...
            <view v-if="setting.personalExpanded">
              <view class="setting-row">
                ...
                <view
                  class="ink-switch"
                  :class="{ active: setting.store.showGanZhi }"
                  @tap="setting.onGanZhiToggle({ detail: { value: !setting.store.showGanZhi } })"
                >
                  <view class="ink-switch-track"></view>
                  <view class="ink-switch-knob"></view>
                </view>
              ...
              <view class="setting-row">
                ...
                <view
                  class="ink-switch"
                  :class="{ active: setting.store.showPointCode }"
                  @tap="setting.onPointCodeToggle({ detail: { value: !setting.store.showPointCode } })"
                >
                  <view class="ink-switch-track"></view>
                  <view class="ink-switch-knob"></view>
                </view>
              ...
              <view class="setting-row no-border">
                ...
                <view
                  class="ink-switch"
                  :class="{ active: setting.store.showWuXing }"
                  @tap="setting.onWuXingToggle({ detail: { value: !setting.store.showWuXing } })"
                >
                  <view class="ink-switch-track"></view>
                  <view class="ink-switch-knob"></view>
                </view>
