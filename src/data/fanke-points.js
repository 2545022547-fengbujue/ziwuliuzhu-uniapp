 ...
 * 反克法取穴表（教材表10-12）
 *
 * 反克法（142530反克法）是纳甲法闭穴时的补充取穴方案。
 * 规则：一、四、二、五、三、〇反克取穴
 *
 * 查表方式：日干 + 时辰干支 → 穴位
 * 格式：FANKE_TABLE['日干+时辰干支'] = { code, name, wuxing, type }
 *
 * 说明：
 * - 六甲 = 日干为甲的六个时辰（甲戌、甲子、甲寅、甲辰、甲午、甲申）
 * - 每个时辰对应不同的日干组合（如甲戌是甲日戌时，甲子是己日子时）
 * - type 字段标识穴位类型：井穴、荥穴、输穴、经穴、合穴、气纳三焦、血归包络
 */
