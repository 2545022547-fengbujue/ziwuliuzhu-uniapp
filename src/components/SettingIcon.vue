...
// App 端 PNG 路径：/static/icons/setting-<icon>-<uiStyle>.png
// 仅 6 套非经典设置页使用本组件（activeUiStyle 必为其中之一，PNG 必存在）。
const pngSrc = computed(() => `/static/icons/setting-${props.name}-${store.activeUiStyle}.png`)
</script>
